            ...
            <form action="../public/procesar_formulario.php" method="post">
                ...
                <div class="question-box">
                    ...
                    <select id="perfil" name="perfil" required>
                        ...
                        <option value="corporate">Organizacion</option>
                        <option value="inversor">Inversor</option>
                        <option value="investigador">Investigador</option>
                        <option value="partner">Aliado estrategico</option>
                        <option value="evaluadores">Evaluadores</option>
                        <option value="evaluadores">Emprendedor</option>
                ...
                <div class="question-box" id="otros-campo-accion-box" style="display: none;">
                    ...
                    <input type="text" id="campo_accion_otro" name="campo_accion">
                </div>
