...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === "PUT" && action === "actualizar-descripcion") {
      ...
      await pool.query("UPDATE cursos SET descripcion = ? WHERE id = ?", [descripcion, curso_id]);
    ...
    if (req.method === "PUT" && action === "editar") {
      ...
      const { curso_id, nombre, descripcion, profesor_id, portada_url, visibilidad, estado } = req.body || {};
